...
class UserRegisterFrom(forms.Form):
    user_name = forms.CharField(max_length=20, widget=forms.TextInput(attrs={'placeholder':  'enter user plz'}))
    email = forms.EmailField(widget=forms.EmailInput(attrs={'placeholder': 'enter email plz'}))
    first_name = forms.CharField(max_length=30, widget=forms.TextInput(attrs={'placeholder': 'enter your lastname'}))
    last_name = forms.CharField(max_length=30, widget=forms.TextInput(attrs={'placeholder': 'enter your name'}))
